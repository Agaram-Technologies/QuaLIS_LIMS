...
public class TestCoverageApprovalConfiguration extends BrowserOperation
{
	...
	public static void registrationType(String registrationSubType, boolean autoJobAllocation, boolean autoComplete, String filterStatus, String validationStatus, String approvalStatus ) throws InterruptedException {
		...
		{
			registrationType=RegistrationTypeDetail.registrationTypePurifiedWater;
		}
		else if(registrationSubType.equals(RegistrationTypeDetail.registrationSubTypeHylandsPurifiedWater))
		{
			registrationType=RegistrationTypeDetail.registrationTypePurifiedWater;
