...
public class ElementGenericRegistrationIrshaRoutine {
	@FindBy(id="iMenuID_2")
	...
	@FindBy(id="ID_SR_Dynamic_7814")
    public static WebElement projectID;
	
	
	@FindBy(id="ID_SR_Dynamic_7815")
	...
	@FindBy(id="ID_SR_Dynamic_7805")
    public static WebElement sponserSite;
	

	
	@FindBy(id="ID_SR_Dynamic_7806")
    public static WebElement sponserID;
	

	
	@FindBy(id="ID_SR_Dynamic_7807")
    public static WebElement visitNumber;
	
	
	@FindBy(id="ID_SR_Dynamic_7809")
    public static WebElement quantity;
	
	
	@FindBy(id="ID_SR_Dynamic_7810")
    public static WebElement quantityUnit;
	

	@FindBy(id="ID_SR_Dynamic_7811")
    public static WebElement batchNumber;
	

	@FindBy(id="ID_SR_Dynamic_7812")
