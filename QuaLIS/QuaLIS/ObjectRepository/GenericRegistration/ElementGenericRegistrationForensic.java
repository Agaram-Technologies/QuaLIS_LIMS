...
public class ElementGenericRegistrationForensic
{
	...
	@FindBy(id="ID_SR_Dynamic_1201")
    public static WebElement client;
	
	
	@FindBy(id="ID_SR_Dynamic_1202")
    public static WebElement sampleCategory;
	
	
	@FindBy(id="ID_SR_Dynamic_1203")
    public static WebElement sampleType;
	
	@FindBy(id="ID_SR_Dynamic_1206")
    public static WebElement caseSource;
	
	@FindBy(id="ID_SR_Dynamic_1207")
	...
	@FindBy(id="ID_SR_Dynamic_1209")
    public static WebElement storageCondition;
	
	@FindBy(id="ID_SR_Dynamic_1210")
    public static WebElement numberOfExhibit;
	
	@FindBy(id="ID_SR_Dynamic_1211")
    public static WebElement exhibitReceived;
	
	@FindBy(id="ID_SR_Dynamic_1214")
    public static WebElement disposition;
	
	@FindBy(id="ID_SR_Dynamic_1215")
    public static WebElement priority;
	
	@FindBy(id="ID_SR_Dynamic_1216")
    public static WebElement analysisOrInvestigationRequired;
	
	@FindBy(id="ID_SR_Dynamic_1217")
    public static WebElement otherCaseRefrence;
	
	@FindBy(id="ID_SR_Dynamic_1218")
    public static WebElement subjectInfo;
	
	@FindBy(id="ID_SR_Dynamic_1219")
    public static WebElement totalQuanity;
	
	@FindBy(id="ID_SR_Dynamic_1220")
    public static WebElement totalQuantityUnit;
	
	@FindBy(id="ID_SR_Dynamic_1221")
    public static WebElement deadLine;

	@FindBy(id="ID_SR_Dynamic_1222")
    public static WebElement deadLinePeriod;

	@FindBy(id="ID_SR_Dynamic_1223")
    public static WebElement specialPrecaution;

	@FindBy(id="ID_SR_Dynamic_1224")
...
//	ID_SR_SampleRegistrationData
    ...
    */
    ...
    public static WebElement sampleExhibiOrSampleInfo;
