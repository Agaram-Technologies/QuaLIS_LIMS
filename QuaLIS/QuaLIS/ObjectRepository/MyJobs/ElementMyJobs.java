...
public class ElementMyJobs
	

{
		

		@FindBy(xpath="//*[@id=\"ID_mjst_DynamicData\"]/div/div[1]/div[2]/p")
		public static List<WebElement> ARNumberList;
		
		@FindBy(xpath="//*[@id=\"ID_mjst_DynamicData\"]/div/div[2]")
		...
		public static List<WebElement> ARNumberList;
	*/	
		@FindBy(xpath="//*[@id=\"ID_mjt_DynamicData\"]/div/div[2]")
		...
		public static WebElement myJobsIcon;

		
		@FindBy(id="iModuleID_28")
	    public static WebElement jobAllocationIcon;
		
		@FindBy(id="ID_mj_combobox_sampletype")
		...
		//*[@id="ID_MJSS_ActionMenu"]/a
		

	    @FindBy(xpath="//*[@id=\"ID_MJSS_ActionMenu\"]/a")
	    public static WebElement myJobsAction;
