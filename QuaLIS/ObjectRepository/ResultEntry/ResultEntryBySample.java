package ResultEntry;
	...
	public class ResultEntryBySample {
		
		

		@FindBy(xpath="//*[@id=\"ID_RBS_ResultEntryMaingetdiv\"]/div/div[1]/div[2]/p")
		...
		@FindBy(id="ID_RE_ResultEntryCheckbox")
		public static WebElement filterCheckbox;
		
	 	@FindBy(id="ID_RBS_Filterstatus")
		...
		public static WebElement resultEntryBySampleAction;
		...
		@FindBy(id="iFormID_56")
	    public static WebElement resultEntryBySampleIcon;
		...
		@FindBy(id="ID_RBS_ResultEntryTestFilterIcon")
	    public static WebElement filterIcon;
		
		
		@FindBy(id="ID_RBS_Registrationtype")
		...
		@FindBy(id="ID_RBS_ResultEntryTestFind")
	    public static WebElement filterFindRecord;
		

		@FindBy(id="ID_RBS_Sampletype")
	  ...
	  //*[@id="ID_SST_OpenFilterPopUP"]/button
		...
		@FindBy(id="ID_RBS_test")
	    public static WebElement testIcon;
		
		@FindBy(id="ID_RBS_ResultEntryTestTestStart")
	    public static WebElement testInitiate;

		@FindBy(id="ID_RBS_ResultEntryTestAdhocParam")
	    public static WebElement testAdhocParammeter;
		
		@FindBy(id="ID_RBS_ResultEntryTestResult")
	    public static WebElement result;
		
		@FindBy(id="ID_RBS_ResultEntryTestComplete")
	    public static WebElement complete;
		
		@FindBy(id="ID_RBS_TestStartSubmit")
	    public static WebElement testInitiateSubmit;
		
		@FindBy(id="ID_RBS_TestStartCancel")
	    public static WebElement testInitiateCancel;
		
		@FindBy(id="ID_RBS_StartRemarks")
	    public static WebElement testInitiateComments;
		
		@FindBy(id="ID_ResultEntry_exportbutton")
	    public static WebElement testExport;
		
		

		@FindBy(id="ID_RBS_Param_0")
	    public static WebElement resultValue;
		
	
		
		
		@FindBy(xpath="//*[@id=\"ID_RBS_Next_0\"]/a")
	    public static WebElement resultSave;
		
		@FindBy(xpath="//*[@id=\"ID_RBS_Next_1\"]/a")
	    public static WebElement resultSave1;
		
		@FindBy(xpath="//*[@id=\"ID_RBS_Next_2\"]/a")
	    public static WebElement resultSave2;
		
		@FindBy(xpath="//*[@id=\"ID_RBS_Next_3\"]/a")
	    public static WebElement resultSave3;
		
		@FindBy(xpath="//*[@id=\"ID_RBS_Next_4\"]/a")
	    public static WebElement resultSave4;
