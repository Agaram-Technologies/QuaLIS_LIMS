...
public class ElementResultEntryBySampleInstrument {
    ...
    public static WebElement testInitiation;
	

	@FindBy(id="ID_RBS_StartFromDate")
    public static WebElement testInitiationDate;
	
	@FindBy(id="ID_RBS_StartRemarks")
    public static WebElement testInitiationDescrition;
	
	@FindBy(id="ID_RBS_TestStartSubmit")
    public static WebElement testInitiationSubmit;
	
	@FindBy(id="ID_RBS_TestStartCancel")
    public static WebElement testInitiationCancel;
    ...
    public static WebElement testResultResult;
	
	
	
	@FindBy(id="ID_RBS_Next_0")
    public static WebElement testResultSave;
	
	
	@FindBy(id="ID_RBS_ResultEntryTestComplete")
    public static WebElement testComplete;
	
	@FindBy(id="ID_mj_accept")
    public static WebElement testAdhocParameter;
	
	@FindBy(id="ID_mj_accept")
    public static WebElement testExportExcel;
