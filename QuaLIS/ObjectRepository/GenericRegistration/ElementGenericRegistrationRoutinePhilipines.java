...
public class ElementGenericRegistrationRoutinePhilipines {
	@FindBy(id="iMenuID_2")
	...
	@FindBy(id="ID_SR_Dynamic_1001")
    public static WebElement client;
	
	
	@FindBy(id="ID_SR_Dynamic_1002")
    public static WebElement sampleCategory;
	
	
	@FindBy(id="ID_SR_Dynamic_1003")
    public static WebElement sample;
	

	@FindBy(id="ID_SR_Dynamic_1006")
    public static WebElement manufacture;
	

	
	@FindBy(id="ID_SR_Dynamic_1007")
    public static WebElement supplier;
	

	
	@FindBy(id="ID_SR_Dynamic_1008")
    public static WebElement receivedDate;
	
	
	@FindBy(id="ID_SR_Dynamic_1009")
    public static WebElement carriedSample;
	
	
	@FindBy(id="ID_SR_Dynamic_1010")
    public static WebElement containerType;
	

	@FindBy(id="ID_SR_Dynamic_1011")
    public static WebElement sampleCondition;
	
	
	
	@FindBy(id="ID_SR_Dynamic_1012")
    public static WebElement storageCodition;
	
	@FindBy(id="ID_SR_Dynamic_1013")
    public static WebElement relativeHumanity;
	

	@FindBy(id="ID_SR_Dynamic_1014")
    public static WebElement ourFileCode;
	
	@FindBy(id="ID_SR_Dynamic_1015")
    public static WebElement disposition;
	
	@FindBy(id="ID_SR_Dynamic_1016")
    public static WebElement totalQuantity;
	
	@FindBy(id="ID_SR_Dynamic_1018")
    public static WebElement priority;
	
	
	@FindBy(id="ID_SR_Dynamic_1017")
    public static WebElement totalQuantityUnit;
	
	@FindBy(id="ID_SR_Dynamic_1021")
    public static WebElement deadLine;

	@FindBy(id="ID_SR_Dynamic_1022")
    public static WebElement deadLinePeriod;

	@FindBy(id="ID_SR_Dynamic_1019")
    public static WebElement batchNumber;
	
	
	@FindBy(id="ID_SR_Dynamic_1020")
    public static WebElement lotNumber;


	@FindBy(id="ID_SR_Dynamic_1023")
    public static WebElement remarks;
	


	@FindBy(id="ID_SR_Dynamic_1024")
