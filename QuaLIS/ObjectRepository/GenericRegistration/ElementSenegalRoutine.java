...
public class ElementSenegalRoutine extends BrowserOperation{
	...
	@FindBy(xpath = "//*[@displaymember='scarriedsample']")
	public static WebElement writingCarryingOnSample;
	
	@FindBy(xpath = "//*[@displaymember='ssampledescription']")
	...
	public static WebElement sreasonsampletesting;

	@FindBy(xpath = "//*[@displaymember='sadditionalremarks']")
	public static WebElement specialRemarks;


	@FindBy(xpath = "//*[@displaymember='sspecialprecautions']")
	public static WebElement specialPreCautions;
	...
	@FindBy(xpath = "//*[@displaymember='sdeadlineindays']")
	...
	@FindBy(id = "ID_SampleRegistration_Samplefileattachment")
