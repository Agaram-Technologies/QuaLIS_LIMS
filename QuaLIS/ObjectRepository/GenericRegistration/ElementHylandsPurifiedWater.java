...
/*	
	...
	*/
	...
	@FindBy(id="ID_SR_Dynamic_10002")
    public static WebElement sample;
	

	@FindBy(id="ID_SR_Dynamic_10005")
    public static WebElement itemCode;
	
	@FindBy(id="ID_SR_Dynamic_10006")
    public static WebElement sampleSite;
	

	
	@FindBy(id="ID_SR_Dynamic_10007")
    public static WebElement dropSample	;
	

	
	@FindBy(id="ID_SR_Dynamic_10008")
    public static WebElement timerID;
	
	
	@FindBy(id="ID_SR_Dynamic_10009")
    public static WebElement lotNumber;
	
	
	@FindBy(id="ID_SR_Dynamic_10010")
