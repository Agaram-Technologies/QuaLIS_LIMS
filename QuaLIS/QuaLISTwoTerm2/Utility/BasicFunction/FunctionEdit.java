...
public class FunctionEdit  extends ElementName
{
	...
	public static void editDescriptionValueToValue(HashMap<String, String> value, HashMap< String, WebElement> element,HashMap<String, List<WebElement>> list) throws InterruptedException
	{
