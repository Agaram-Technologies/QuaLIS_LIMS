	...
	
{
	...
	public static HashMap<String, List<WebElement>> list()
	{
		 ...
		 elements.put(nameList,  methodCategoryList);
		 
		 elements.put(descriptionList,  methodCategoryDescriptionList);
		 
		 elements.put(checkBoxList,  methodCategoryCheckboxList);
	...
	{		
		 ...
		 menu.put(screenName, ScreenName.methodCategory);
