...
public class ElementJobAllocationJobAllocationForensic {
    ...
    public static WebElement jobJobAllocaitonIcon;
		...
		@FindBy(xpath="//*[@id=\"ID_jast_DynamicData\"]/div/div[2]")
	    public static List<WebElement > checkboxList;
		

		@FindBy(xpath="//*[@id=\"ID_jat_DynamicData\"]/div/div[1]/div[2]/p")
	    public static List<WebElement >testList;
		
		@FindBy(xpath="//*[@id=\"ID_jat_DynamicData\"]/div/div[2]")
	    public static List<WebElement > testCheckboxList;
		
		//*[@id="ID_JAT_SelectDiv_1"]
		
		
		//*[@id="ID_jat_DynamicData"]
